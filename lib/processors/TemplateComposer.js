...
export class TemplateComposer {
  ...
  async copyBundlerConfig() {
    ...
    // bundlers/{bundler}/vite.config.{framework}-{languageAbbr}.js
    const configFileName = `${bundler}.config.${framework}-${languageAbbr}.js`;
    const configSrc = path.join(this.templatesBaseDir, 'bundlers', bundler, configFileName);
  ...
  async copyBundlerPlugins() {
    ...
    const bundlerDir = path.join(this.templatesBaseDir, 'bundlers', bundler);
