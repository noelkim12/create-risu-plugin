...
export const LOCATOR = {
  chatScreen: {
    root: {
      cssClass: ['div.absolute.top-0.left-0.w-full.h-full'],
      className: `${PLUGIN_NAME}-root`,
    },
    inputContainer: {
      cssClass: ['div.mt-2.mb-2.flex.items-stretch.w-full'],
      className: `${PLUGIN_NAME}-input-container`,
    },
    textarea: {
      cssClass: ['div.mt-2.mb-2.flex.items-stretch.w-full > textarea'],
      className: `${PLUGIN_NAME}-input-textarea`,
    },
    sendButton: {
      cssClass: ['button.button-icon-send', '.button-icon-send'],
      className: `${PLUGIN_NAME}-send-button`,
    },
    burgerButton: {
      cssClass: [
        'button.peer-focus\:border-textcolor.mr-2.flex.border-y.border-r.border-darkborderc.justify-center.items-center.text-gray-100.p-3.rounded-r-md.hover\:bg-blue-500.transition-colors',
